...
var newspaper_scene = preload("res://gui/event/Newspaper.tscn")
var report_scene = preload("res://gui/report/Report.tscn")
var event_editor_scene = preload("res://gui/event/EventEditor.tscn")
